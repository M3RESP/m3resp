...
| `emg.subtract_baseline` | `processed_emg`, `baseline` | — | `processed_emg_baseline_subtracted` (envelope minus baseline, clipped at 0), `baseline_subtracted` (zeros); map back onto `processed_emg`/`baseline` with `out:` | native |

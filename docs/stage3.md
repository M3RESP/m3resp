...
Stage 2 built several things specifically so Stage 3 would not need to touch them. See the [architecture guide](developer/architecture.md) for the full breakdown; in short:

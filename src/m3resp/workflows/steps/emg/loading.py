...
@register_step(
    ...
    session_writes=("session.raw.emg", "session.raw.ventilator"),
    input_artifacts=(_SESSION_ARTIFACT,),
    parameters=(
        StepParameter(
            name="start_seconds",
            ...
            unit="s",
            minimum=0,
            description="Start of the part to keep, in seconds from the start of the recording as it is now (after any earlier cropping).",
        ),
        StepParameter(
            name="end_seconds",
            value_type="number",
